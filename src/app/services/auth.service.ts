...
import { createUserWithEmailAndPassword, getAuth, onAuthStateChanged, sendEmailVerification, signInWithEmailAndPassword, signOut } from '@angular/fire/auth';
    ...
    .then((userCredential) => {
      // Signed in
        ...
        if(!userCredential.user.emailVerified){
          this.message.Warning(`Antes de intentar ingresar debe validar su email. Por favor revise su correo ${email}`);
          this.cerrarSesion();
          return;
        }
